...
class Fantasy(object):
    ...
    def refresh_rosters(self):
        ...
        for league in self.active_leagues:
            yr = "2020"
            if league == "162788" or league == "3154" or league == "6455":
                yr = "2021"
    ...
    def build_transactions(self, leagueID):
        ...
        url_name = "http://fantasy.espn.com/apis/v3/games/flb/seasons/" + self.roster_year + \
                   "/segments/0/leagues/" + \
                    ...
                    if 'items' in transaction:
                        for i in transaction['items']:
                            ...
                            if int(i['fromLineupSlotId']) >= 0:
                                from_position = self.position[str(i['fromLineupSlotId'])]
